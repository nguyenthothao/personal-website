...
export default function IndexPage() {
  return (
    <div>
      <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-gradient-to-t from-orange-400 via-red-500 to-pink-500">
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
          <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              <h1 className="text-3xl font-bold pt-8 lg:pt-0">Nguyễn Thọ Thảo</h1>
              ...
              <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                ...
                117 Nguyễn Thuật, Hoà An, Cẩm Lệ, Đà Nẵng
              </p>
              ...
              <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                <a className="link" href="https://www.facebook.com/thao.nguyentho/" data-tippy-content="@facebook_handle">
                  <svg
                ...
                <a className="link" href="https://github.com/nguyenthothao1996" data-tippy-content="@github_handle">
                  <svg
                    className="h-6 fill-current text-gray-600 hover:text-green-700"
                    role="img"
                    viewBox="0 0 24 24"
